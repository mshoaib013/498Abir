...
class CounterOne extends Component {
  ...
  serviceOne() {
    ...
    if (this.props.office_data.coFiveTotal > 0) {
      if (date2 != null) {
        this.props.editOfficeProfile(
          this.props.loggedInUsedr.o_mail,
          {
            coFiveTotal: this.props.office_data.coFiveTotal - 1,
            coFiveTime: date2
          },
    ...
    return (
      <Card className="cdrdView">
        <div className="container">
          <h1 className="">Counter Five</h1>
          <br />
          <h2 className="">Last Service Time</h2>
          <h2 className="">{this.props.office_data.coFiveTime} Seconds</h2>
          <br />
          <h2 className="">Counter Total</h2>
          <h2 className="">{this.props.office_data.coFiveTotal}</h2>
          <br />

...
class CounterOne extends Component {
  ...
  serviceOne() {
    ...
    if (this.props.office_data.coFourTotal > 0) {
      if (date2 != null) {
        this.props.editOfficeProfile(
          this.props.loggedInUsedr.o_mail,
          {
            coFourTotal: this.props.office_data.coFourTotal - 1,
            coFourTime: date2
          },
    ...
    return (
      <Card className="cdrdView">
        <div className="container">
          <h1 className="">Counter Four</h1>
          <br />
          <h2 className="">Last Service Time</h2>
          <h2 className="">{this.props.office_data.coFourTime} Seconds</h2>
          <br />
          <h2 className="">Counter Total</h2>
          <h2 className="">{this.props.office_data.coFourTotal}</h2>
          <br />

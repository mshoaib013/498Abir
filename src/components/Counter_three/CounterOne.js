...
class CounterOne extends Component {
  ...
  serviceOne() {
    ...
    if (this.props.office_data.coThreeTotal > 0) {
      if (date2 != null) {
        this.props.editOfficeProfile(
          this.props.loggedInUsedr.o_mail,
          {
            coThreeTotal: this.props.office_data.coThreeTotal - 1,
            coThreeTime: date2
          },
    ...
    return (
      <Card className="cdrdView">
        <div className="container">
          <h1 className="">Counter Three</h1>
          <br />
          <h2 className="">Last Service Time</h2>
          <h2 className="">{this.props.office_data.coThreeTime} Seconds</h2>
          <br />
          <h2 className="">Counter Total</h2>
          <h2 className="">{this.props.office_data.coThreeTotal}</h2>
          <br />

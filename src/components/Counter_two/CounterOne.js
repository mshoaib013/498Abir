...
class CounterOne extends Component {
  ...
  serviceOne() {
    ...
    if (this.props.office_data.coTwoTotal > 0) {
      if (date2 != null) {
        this.props.editOfficeProfile(
          this.props.loggedInUsedr.o_mail,
          {
            coTwoTotal: this.props.office_data.coTwoTotal - 1,
            coTwoTime: date2
          },
    ...
    return (
      <Card className="cdrdView">
        <div className="container">
          <h1 className="">Counter Two</h1>
          <br />
          <h2 className="">Last Service Time</h2>
          <h2 className="">{this.props.office_data.coTwoTime} Seconds</h2>
          <br />
          <h2 className="">Counter Total</h2>
          <h2 className="">{this.props.office_data.coTwoTotal}</h2>
          <br />
